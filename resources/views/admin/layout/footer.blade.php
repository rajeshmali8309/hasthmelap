<!-- content-wrapper ends -->
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © {{ date('Y') }}  <span style="color: rgb(247, 156, 129)">Hasthmelap Metrimony</span>. All rights reserved.</span>
            </div>
          </footer>
          <!-- partial -->
        </div>
